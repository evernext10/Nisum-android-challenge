...
class GetListProductsBySearchUseCaseTest {
    ...
    private fun handleSuccess(marketplacePokemonListResponse: MarketplacePokemonListResponse) {
        Truth.assertThat(marketplacePokemonListResponse.results).isNotEmpty()
    }
